package com.example.testtaskapp.gif_detail
...
import com.example.testtaskapp.databinding.ActivityGifDetailBinding
...
class GifDetailActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val args = intent.getParcelableExtra<Args>(ARGS) as Args
